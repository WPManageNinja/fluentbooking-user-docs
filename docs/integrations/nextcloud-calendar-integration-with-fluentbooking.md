---
title: Nextcloud Calendar Integration with FluentBooking
description: Sync FluentBooking events with Nextcloud Calendar. Connect and sync booking events in a few steps.
---
...
Login to your **Nextcloud Developer [Account](https://nextcloud.com/sign-up/)** to get the **Primary CalDav URL**. Now select **Calendar** from your Nextcloud account and click on the **Calendar Settings**.

![Nextcloud CalDav Primary URL](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/1-1.webp)

Now Scroll down to get the **CalDav Primary URL** and copy the **URL** from here.

![Get CalDav Primary URL](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/2-1.webp)
...
![Nextcloud Calendar Settings](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/3-1.webp)
...
![Host Settings](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-1.webp)

Now select the **Remote Calendar** from the left sidebar and select the **Connect with Nextcloud Calendar** button.

![Connect with Nextcloud Calendar](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-2.webp)
...
![Add Specific Password](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-3.webp)
...
![Nextcloud Profile Settings](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-4.webp)

Select the **Security** from the left sidebar.

![Choose Security](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-5.webp)
...
![Create new app password](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-6.webp)
...
![Copy Credenytials](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-7.webp)
...
![Connect with Nextcloud Calendar](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-8.webp)

Now select the Nextcloud calendar to add the booking events on the selected calendar.

![Add Calendar](/images/integrations/nextcloud-calendar-integration-with-fluentbooking/host-9.webp)
